...
func main() {
	...
	for {
		...
		fmt.Println("5. Search Document Sequential")
		fmt.Println("6. Search Document Binary")
		fmt.Println("7. Sort Document Selection")
		fmt.Println("8. Sort Document Insertion")
		fmt.Println("9. Exit")
		fmt.Scan(&option)
